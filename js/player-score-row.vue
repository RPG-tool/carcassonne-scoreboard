<template>
  <div class="player-score" :id="'player-score-' + player.color">
    ...
    <br />
    <button
      :disabled="player.score === 0 || player_aditional_score === 0"
    ...
    />
    <button
      :disabled="player_aditional_score === 0"
