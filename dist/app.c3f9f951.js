...
var _default = new _vuex.default.Store({
  ...
  mutations: {
    ...
    RESET_PLAYER_SCORE: function RESET_PLAYER_SCORE(state) {
      return state.players = state.players.map(function (player) {
        return player.score = 0;
      });
    },
    RESET_PLAYER_STATUS: function RESET_PLAYER_STATUS(state) {
      return state.players = state.players.map(function (player) {
...
var _default = {
  ...
  computed: {},
  watch: {},
  methods: _objectSpread({}, (0, _vuex.mapMutations)(["INIT_GAME"])),
...
exports.default = _default;
  ...
  return _c("div", [
    _c("ul", [
      ...
      _vm._v(" "),
      _c("li", [
        _c("button", { on: { click: _vm.INIT_GAME } }, [_vm._v("Start game")])
      ])
    ])
  ])
}
...
},{"vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"js/choosing-players-and-mode.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $425131 = exports.default || module.exports;
      
      if (typeof $425131 === 'function') {
        $425131 = $425131.options;
      }
    
        /* template */
        Object.assign($425131, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "div",
    [
      _c("div", [_vm._v("Choose game variant and number of players")]),
      _vm._v(" "),
      _c("label", [
        _c("input", {
          directives: [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$425131', $425131);
          } else {
            api.reload('$425131', $425131);
          }
        }
...
exports.default = _default;
        var $1c06d9 = exports.default || module.exports;
      
      if (typeof $1c06d9 === 'function') {
        $1c06d9 = $1c06d9.options;
      }
    
        /* template */
        Object.assign($1c06d9, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$1c06d9', $1c06d9);
          } else {
            api.reload('$1c06d9', $1c06d9);
          }
        }
...
//   console.log('Ready!');
// });
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./store":"js/store.js","./app.vue":"js/app.vue"}],"../../../../../.asdf/installs/nodejs/8.11.3/.npm/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../.asdf/installs/nodejs/8.11.3/.npm/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/app.js"], null)
